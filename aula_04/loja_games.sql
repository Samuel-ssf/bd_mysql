...
-- Schema db_loja_games
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_loja_games` DEFAULT CHARACTER SET utf8 COLLATE utf8_esperanto_ci ;
USE `db_loja_games` ;
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  INDEX `fk_tb_produtos_tb_usuarios1_idx` (`tb_usuarios_id` ASC),
